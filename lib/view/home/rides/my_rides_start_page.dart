...
class MyRidesStartPage extends StatefulWidget {
  const MyRidesStartPage({Key? key}) : super(key: key);

  @override
  State<MyRidesStartPage> createState() => MyRidesStartPageState();
}

class MyRidesStartPageState extends State<MyRidesStartPage> {
  @override
