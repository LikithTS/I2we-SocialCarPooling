    ...
    children: [
      if (data.upcomingRides != null && data.upcomingRides!.isNotEmpty) ... [
        UpcomingRidesWidget(
          ...
          coRidersCount: "2",
          leftButtonText: data.upcomingRides?.firstWhere((element) => true).rideStatus ?? Constant.RIDE_CANCELLED,
          rideStatus: data.upcomingRides?.firstWhere((element) => true).rideStatus ?? Constant.RIDE_CREATED,
      ...
      if (data.recentRides != null && data.recentRides!.isNotEmpty) ... [
        RecentRidesWidget(
          ...
          carType: data.recentRides?.firstWhere((element) => true).carTypeInterested ?? Constant.CAR_TYPE_SEDAN,
          coRidersCount: "2",
          leftButtonText: data.recentRides?.firstWhere((element) => true).rideStatus ?? Constant.RIDE_CANCELLED,
          rideStatus: data.recentRides?.firstWhere((element) => true).rideStatus ?? Constant.RIDE_COMPLETED,
        ),
      ],
